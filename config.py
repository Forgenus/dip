...
NEURAL_N_MELS = int(os.getenv("NEURAL_N_MELS", "128"))
...
NEURAL_TRAIN_BATCH_SIZE = int(os.getenv("NEURAL_TRAIN_BATCH_SIZE", "64"))
...
NEURAL_QUERY_AUGMENTATION_ENABLED = os.getenv("NEURAL_QUERY_AUGMENTATION_ENABLED", "True").lower() in ("true", "1", "yes")
NEURAL_QUERY_NOISE_MIN = float(os.getenv("NEURAL_QUERY_NOISE_MIN", "0.01"))
NEURAL_QUERY_NOISE_MAX = float(os.getenv("NEURAL_QUERY_NOISE_MAX", "0.03"))
NEURAL_QUERY_VOLUME_MIN = float(os.getenv("NEURAL_QUERY_VOLUME_MIN", "0.25"))
NEURAL_QUERY_VOLUME_MAX = float(os.getenv("NEURAL_QUERY_VOLUME_MAX", "3.0"))
NEURAL_QUERY_TIME_STRETCH_MIN = float(os.getenv("NEURAL_QUERY_TIME_STRETCH_MIN", "0.97"))
NEURAL_QUERY_TIME_STRETCH_MAX = float(os.getenv("NEURAL_QUERY_TIME_STRETCH_MAX", "1.03"))
...
NEURAL_TRAIN_DEFAULT_NUM_WORKERS = "0" if os.name == "nt" else "4"
NEURAL_TRAIN_NUM_WORKERS = int(os.getenv("NEURAL_TRAIN_NUM_WORKERS", NEURAL_TRAIN_DEFAULT_NUM_WORKERS))
